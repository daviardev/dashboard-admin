<table>
    ...
    $rol = "SELECT * FROM sub_items WHERE id_items = 2";
    $document = mysqli_query($conn, $rol);

    while ($row = mysqli_fetch_array($query, $document)) {
        echo "<tr>";
        echo "<td>".$row['id']."</td>";
        ...
        echo "<td>";
        echo "<button class='action' onclick='Edit(".$row['id']."'>";
        ...
        echo "<button class='action' onclick='Delete(".$row['id'].">";
